...
public class JdbcStudentDao implements StudentDao {
	...
	private final String SELECT_STUDENTS_QUERY = "SELECT ID, NAME, AVGMARK, AGE FROM STUDENTS;";
	...
	public void insertStudent(Student student) {
		...
		try {
			...
			System.err.println("JdbcStudentDao.insertStudent: "
					+ ex.getMessage());
		} finally {
			try {
	...
	public Student getStudent(int id) {
		...
		try {
			...
			System.err.println("JdbcStudentDao.getStudent: " + ex.getMessage());
		} finally {
			try {
				if (pstmt != null && pstmt.isClosed()) {
					pstmt.close();
	...
	public void updateStudent(Student student) {
		...
		try {
			...
			System.err.println("JdbcStudentDao.updateStudent: "
					+ ex.getMessage());
		} finally {
			try {
				if (pstmt != null && pstmt.isClosed()) {
	...
	public void deleteStudent(int id) {
		...
		try {
			...
			System.err.println("JdbcStudentDao.deleteStudent: "
					+ ex.getMessage());
		} finally {
			try {
				if (pstmt != null && pstmt.isClosed()) {
	...
	public List<Student> getStudents() {
		...
		try {
			...
			System.err
					.println("JdbcStudentDao.getStudents: " + ex.getMessage());
		} finally {
			try {
